...
namespace Smart_Metering_Device_Simulator
{
    public partial class Form1 : Form
    {
        ...
        private async void genbtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var path = @"D:\upwork\Alexandra Varga\AlexandraVarga-DS2022_30642_Varga_Alexandra_Assignment_2\Backend\Smart Metering Device Simulator\Smart Metering Device Simulator\File\sensor2.csv";
                ...
                using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
                {
                    ...
                    for (int i = 0; i < records.Count; i++)
                    {
                        ...
                        string url = "http://localhost:7174/api/Producer";
